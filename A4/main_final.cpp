...
ostream&  operator<<(ostream& os, const Action& a){
        string time_str = ctime(&a.action_time);
        time_str.pop_back();
        string log_gen = "I read action number " + to_string(a.action_id) + " of type " + a.action_type + " by user " + to_string(a.user_id) + " at time " + time_str;
        os<<log_gen;
        return os;
}
